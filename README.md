# Language_Translator
 > The **Language Translation Tool** is an AI-based application developed to translate text from one language to another quickly and accurately. This project provides a simple and user-friendly interface where users can enter any text, select the source language and target language, and receive the translated output instantly. The application is developed using Python and Streamlit for the frontend interface, while the translation functionality is implemented using the Google Translator API through the `deep-translator` library. The tool supports multiple languages such as English, Telugu, Hindi, Tamil, French, Spanish, German, Japanese, Korean, Arabic, and many more, making it useful for users around the world.
